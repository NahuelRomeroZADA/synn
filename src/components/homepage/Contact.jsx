    ...
    >
      ...
      <div ref={contactSection} className="mt-10 flex flex-col gap-20 md:grid md:grid-cols-6 md:px-12">
        <div className="col-span-4">
          <h3 ref={heading} className="text-primary-200 max-w-lg 2xl:max-w-3xl text-heading-3 2xl:text-7xl font-semibold leading-tight translate-y-10 opacity-0">
          ...
          >
            ...
            >
              <span className="relative">
                ...
                <span className="group-hover:text-accent-400 text-secondary-700">
                  Send Message
                </span>
              </span>
            </button>
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-primary-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                ...
                rel="noreferrer"
              >
                <span>nahuelromeroofc@gmail.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              <a
                href="https://www.instagram.com/sk.grimm/"
              ...
              <a
                href="https://github.com/NahuelRomeroZADA"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/in/nahuel-romero-6b8171228/"
