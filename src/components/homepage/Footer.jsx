export default function Footer() {
    ...
    return (
      <footer className="bg-[#0E0E0C] mt-14 flex items-end justify-between px-5 py-4 sm:flex text-body-4 md:text-body-3">
        <div className="flex flex-col md:flex-row md:w-[62.5vw] lg:w-[57.5vw] justify-between">
          <div className="flex space-x-1" >
            <span className="text-primary-200">&copy;</span>
            <span className="text-primary-200">2023</span>
            <span className=" text-secondary-700 font-extrabold uppercase 2xl:text-body-1">SYN</span>
          </div>
          <div>
            <span className="text-primary-200 text-body-4 2xl:text-body-1">Site designed and coded with ❤️‍🔥</span>
          </div>
        </div>
        <button onClick={toTop} className="col-span-2 flex items-center space-x-2 w-fit group 2xl:text-body-1">
          <span className=" text-primary-200 font-extrabold uppercase hover:font-black duration-200">BACK TO TOP</span>
